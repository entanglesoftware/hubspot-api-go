...
// InvoiceProperties defines model for InvoiceProperties.
type InvoiceProperties = []interface{}
...
// InvoiceSearchResponse defines model for InvoiceSearchResponse.
...
// InvoicesSearchResponse defines model for InvoicesSearchResponse.
type InvoicesSearchResponse struct {
	Paging  *Paging                  `json:"paging,omitempty"`
	Results *[]InvoiceSearchResponse `json:"results,omitempty"`
